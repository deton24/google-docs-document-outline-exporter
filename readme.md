...
Now the script comes into play. It expects file named "file_a.html" which is a downloaded GDoc as HTML, but this time from dedicated option in the GDoc (so without the navigation bar yet).<br>
...
Now the second script will read all the entries from json you created, and embeed the GDoc-looking document outline into your HTML file downloaded normally with GDoc option. You can edit the json to ensure the script worked correctly, and all the entries are correct.<br>
